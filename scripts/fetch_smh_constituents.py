"""
受控数据获取脚本：获取 SMH (半导体 ETF) 核心前 15 大成分股历史日线收盘价
运行一次并将数据永久固化为本地标准数据集 smh_constituents_local.csv
...
TICKERS = [
    ...
    'QCOM', 'TXN', 'AMAT', 'LRCX', 'MU',
    'ADI', 'INTC', 'KLAC', 'MRVL', 'NXPI'
]

OUTPUT_FILE = 'smh_constituents_local.csv'

def main():
    print(f"🚀 开始受控拉取 SMH 前 15 大核心成分股数据: {TICKERS}")
