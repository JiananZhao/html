...
def load_market_breadth_data(file_path=BREADTH_CSV):
    """
    Reads and caches pre-calculated market breadth CSV data generated by GitHub Actions.
    """
    ...
    try:
        ...
        print(f"Error loading market breadth CSV ({file_path}): {e}")
        return None

def create_market_breadth_chart(df_breadth: pd.DataFrame = None, y_range=None):
    """
    Creates an interactive Plotly chart for S&P 500 Market Breadth (% of stocks above MAs).
    Preserves user zoom/pan states with uirevision.
    """
    ...
    # Reference lines for Overbought (70%) & Oversold (30%)
    fig.add_hline(
        y=70,
        line_dash="dash",
...
def render_market_breadth_ui():
    """
    Renders the Market Breadth UI component in Streamlit.
    """
